    ...
    void ungueltigeAnmeldung_falscheSpielerzahl_shouldReturn400WithMessage() throws Exception {
        ...
        String body =
                ...
                {"disziplinen":[{"disziplin":"HERRENEINZEL","teamName":null,"spieler":[
                  {"vorname":"Max","nachname":"Mustermann","radikalId":"MM-1","initialen":null,"geburtsdatum":null},
                  {"vorname":"Tim","nachname":"Test","radikalId":"TT-1","initialen":null,"geburtsdatum":null}
                ]}]}""";
